...
| | |
|---|---|
| **Задачи** | One-off and recurring chores, assigned by a fairness-weighted rotation rather than by nagging. Points follow whoever actually did the work. |
...
| **Доступ** | Google / Apple / Telegram sign-in, six roles, and registration that only an admin can approve. |
